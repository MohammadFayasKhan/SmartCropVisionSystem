    ...
    def _init_catalog(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "tier2_plantdoc_yolo": {
                ...
                "name": "YOLO26 Multi-Domain Agricultural Detector",
                "architecture": "YOLO26n-PlantDoc",
                "task": "detection",
                "tier": "server",
                "version": "v2.5-production-yolo26",
                "path": settings.GEN2_TIER2_YOLO26_MODEL_PATH if settings.GEN2_TIER2_YOLO26_MODEL_PATH.exists() else settings.TIER2_PLANTDOC_MODEL_PATH,
                "input_resolution": "640x640 (letterbox)",
                "taxonomy_version": "YOLO26-29Class-MultiDomain",
                "val_map50": 0.3415,
                "val_map50_95": 0.2402,
                "is_production_deployed": True,
            },
